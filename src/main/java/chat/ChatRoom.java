...
import chat.utils.DeletedMessagePrinter;
...
public class ChatRoom implements Serializable{
	 ...
	 */
	public boolean delMsg(int messageId, HttpServletResponse response) {
		ChatMsg msg = msgs.remove(messageId);
		new DeletedMessagePrinter().print(msg, response);
		return msg!=null;
	}
}
